...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // DB::connection('pgsql')->statement('CREATE SEQUENCE ai_alerts_alive_id_seq START WITH 1000000');
        DB::connection('pgsql')->statement('CREATE SEQUENCE IF NOT EXISTS ai_alerts_alive_id_seq START WITH 1000000');

        Schema::connection('pgsql')->create('ai_alerts_alive', function (Blueprint $table) {
    ...
    {
        Schema::connection('pgsql')->dropIfExists('ai_alerts_alive');
        DB::connection('pgsql')->statement('DROP SEQUENCE IF EXISTS ai_alerts_alive_id_seq');
    }
};
